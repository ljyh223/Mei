...
@Composable
fun LyricScreen(lyricLines:List<LyricLine>, playerConnection:PlayerConnection, position: Long){
    ...
    val currentIndex = remember(currentLine) {
        lyricLines.indexOfFirst { it == currentLine }
    }
    BoxWithConstraints(
